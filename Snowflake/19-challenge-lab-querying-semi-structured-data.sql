...
-- 19.0.0  Challenge Lab: Querying Semi-Structured Data
...
--         Curly braces and key-value pairs denote objects.
...
--         and analyze the diagram included in this exercise. And don’t be
--         afraid to ask your instructor for help!
...
-- 19.2.0  Create the Semi-Structured Data
--         You must complete all the steps in this section to complete this
--         challenge lab successfully.

-- 19.2.1  Set your context for the lab and make sure you have the standard
--         objects.
...
-- 19.2.2  Run the SQL statement below using JSON literals to create the semi-
--         sturctured data in a VARIANT column.
...
-- 19.2.3  Analyze the diagram to understand the paths.
...
-- 19.3.0  Part I - Use Dot Notation
--         In this portion of the lab, you will use dot notation to get only the
--         data you need.

-- 19.3.1  Write a query that extracts all business and personal phone numbers.

-- 19.3.2  Write a query that extracts all business and personal email
--         addresses.

-- 19.3.3  Write a query that extracts all business and personal addresses.

-- 19.3.4  Continue to the next page for the rest of the exercise.

-- 19.4.0  Part II - Use FLATTEN
--         When using dot notation to extract nested information, you must know
--         the array indices beforehand. In the employee data set, you queried
--         with dot notation, the assumption was that the business contact
--         information was at index 0 while the personal contact information was
--         at index 1. In this specific data set, that is the case. However, in
--         real-life JSON examples, this is often not the case.
--         Imagine shopping for groceries; you don’t always buy the same items
--         or in the same order. The same logic applies to semi-structured data,
--         the JSON structure might be dynamic. Returning to the employee data,
--         it could be that people can add multiple phone numbers and categorize
--         them using a drop-down menu. This could lead to adding a business
--         phone number after adding the personal phone numbers, which would
--         change the order of the data in the JSON file. If we assume that data
--         is always in the same order, our queries may not work as expected.
--         So, we need to come up with a query that is robust to these kinds of
--         behaviors.
--         In this portion of the lab, you will use FLATTEN to get only the data
--         you need. The challenge is writing the queries to extract the data
--         you need without using fixed index values.
--         The diagram has been included for your reference. The SQL is included
--         in the solution on the last page of the exercise. Try your best to
--         figure it out on your own without looking at the solution.

-- 19.4.1  Write a query that extracts all business phone numbers.

-- 19.4.2  Write a query that extracts all personal phone numbers.

-- 19.4.3  Write a query that extracts all business and personal phone numbers.

-- 19.4.4  Write a query that extracts all business email addresses.

-- 19.4.5  Write a query that extracts all personal email addresses.

-- 19.4.6  Write a query that extracts all business and personal email
--         addresses.

-- 19.4.7  Write a query that extracts all business addresses (office and
--         mailing).

-- 19.4.8  Write a query that extracts all personal addresses (home and
--         mailing).

-- 19.4.9  Write a query that extracts all business and personal addresses.

-- 19.4.10 When you are finished, suspend your virtual warehouse.
