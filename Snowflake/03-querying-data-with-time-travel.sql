...
-- 3.1.0   Create a Test Environment
...
CREATE SCHEMA IF NOT EXISTS FALCON_db.regions_dev;
USE SCHEMA FALCON_db.regions_dev;
...
-- 3.4.2   Try to UNDROP the earliest version of the region table.
...
-- 3.4.3   Try to clone the region table at the point in time before inserting
