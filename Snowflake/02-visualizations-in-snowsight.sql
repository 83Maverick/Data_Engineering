...
--         click the three vertical dots that appear on the left side of the
...
-- 2.3.2   Name the dashboard FALCON Gross Sales.
...
--         dashboard. Refresh your browser window if you do not see the
--         dashboard tile.
...
-- 2.3.4   Click - Return to FALCON Gross Sales in the upper left corner.
...
-- 2.4.3   Click - Return to FALCON Gross Sales in the upper left.
...
--         - Snowflake makes it easy to share worksheets with colleagues.
