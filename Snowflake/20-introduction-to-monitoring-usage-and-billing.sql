...
-- 20.0.0  Introduction to Monitoring Usage and Billing
...
-- 20.1.0  Monitor Usage and Billing with the ACCOUNT_USAGE schema
...
-- 20.1.2  Examine credit usage by virtual warehouse.
...
-- 20.1.3  Identifying virtual warehouses with no resource monitor.
...
-- 20.2.1  Most expensive queries from the last 60 days.
...
-- 20.2.2  Top 10 queries with the most spillage to remote storage.
