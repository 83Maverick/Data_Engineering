...
-- 11.0.0  User-Defined Functions and User-Defined Table Functions
...
-- 11.1.0  Enable a Customer Search via a User-defined Table Function
...
-- 11.1.2  Write the CREATE FUNCTION portion of the statement.
...
-- 11.1.3  Add the RETURNS TABLE portion of the function.
...
-- 11.1.5  Run the statements below.
...
-- 11.1.6  Fetch a list of the top 10 orders for Noah Yamada.
...
-- 11.1.7  Fetch the top 10 orders.
...
-- 11.2.0  Create a Scalar User-defined Function (SQL)
...
-- 11.2.1  Execute the SQL function.
...
-- 11.3.0  Create a Scalar User-defined Function (JavaScript)
...
-- 11.4.0  Create a User-defined Table Function to Fetch Line Items for a
--         Specific Order
...
-- 11.5.0  Select from a Table Using a Scalar User-defined Function
...
-- 11.5.1  Suspend your virtual warehouse.

ALTER WAREHOUSE FALCON_wh SUSPEND;


-- 11.6.0  Key Takeaways
