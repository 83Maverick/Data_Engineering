...
-- 14.0.0  Challenge Lab: Snowflake Stored Procedures and Snowflake Scripting
...
-- 14.1.0  Create a Stored Procedure

-- 14.1.1  Set your context using a new schema called STORED_PROCS_CHALLENGE.

-- 14.1.2  Create the nation table and put in some values.
...
-- 14.1.3  Create a table for each region in the nations table.
...
-- 14.1.4  Create the log table.

-- 14.1.5  Write and call your stored procedure.

-- 14.1.6  Verify all tables to make sure the data looks as you expect.

-- 14.1.7  Suspend your virtual warehouse.
...
CREATE OR REPLACE SCHEMA FALCON_DB.STORED_PROCS_CHALLENGE;
USE SCHEMA FALCON_DB.STORED_PROCS_CHALLENGE;
